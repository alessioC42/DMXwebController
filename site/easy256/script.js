...
var scenes = [];
var state_blackout = Array(256).fill(0);
var state_flash = Array(256).fill(255);
...
function getMaxSceneFaderValues() {
    let maxFaderStates = Array(256).fill(0);
...
function exportSettings() {
    ...
    }, "DMXexport_typeeasy256_" + getFormattedDate());
}

function importSettings() {
    openJSONFile((object) => {
        if (!(object.board == "easy256")) {
            bs5Utils.Snack.show('danger', 'this file is not compatible', delay = 1500, dismissible = true);
        } else {
