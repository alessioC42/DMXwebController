...
var scenes = [];
var state_blackout = Array(64).fill(0);
var state_flash = Array(64).fill(255);
...
function getMaxSceneFaderValues() {
    let maxFaderStates = Array(64).fill(0);
...
function exportSettings() {
    ...
    }, "DMXexport_typeeasy64_" + getFormattedDate());
}

function importSettings() {
    openJSONFile((object) => {
        if (!(object.board == "easy64")) {
            bs5Utils.Snack.show('danger', 'this file is not compatible', delay = 1500, dismissible = true);
        } else {
